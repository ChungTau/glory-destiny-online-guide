// apps/api/src/features/skill/pet-skill/pet-skill.controller.ts
...
export class PetSkillLinkController extends BaseController<
  EntityPayloadWithInclude<typeof Prisma.ModelName.PetSkillLink, Prisma.PetSkillLinkInclude>,
